...
// LMS management pages
export { LmsContentPage } from './LmsContentPage';
...
export { default as AssignCoursePage } from './AssignCoursePage';
export { default as CourseSummaryPage } from './CourseSummaryPage';
